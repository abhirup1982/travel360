            ...
            <div class="col-lg-12">
                <div class="row" id="grad1" >
                    <div class="col-md-10">
                        ...
                        <a href="<spring:eval expression="@environment.getProperty('travel360.registration.url')" />/edit?token=${jwt_token}&language=${language}"><span style="color:white;font-family: 'Book Antiqua'"><spring:message code="edit.profile.message"></spring:message></span></a>
                    </div>
                    <div class="col-md-2">
                            ...
                            <div style="padding-top: 4%;">
                                <form class="form-inline" method="get" id="searchFlightForm" name="searchFlightForm">
                                    <div style="margin-left: 2%;">
                                        ...
                                        <input name="pointOfSale" id="pointOfSale" type="hidden" value="${pointOfSale}"/>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="content-1" class="content">
                            <p style="color: white; font-size:medium; font-family:Book Antiqua;font-weight: bold;"><spring:message code="dream.holiday.message"></spring:message></p>
                            <ul>
                                ...
                                <li><div class = "promo" onmouseleave="$('#beach').hide(700)" onmouseover="$('#beach').show(700)"><img src="../search/resources/img/beach.jpg" class="image_scroll" onload="$('#beach').hide()"/>
                                        <div id="beach" class="hilight">
                                            <i style="font-family: 'Book Antiqua';font-size: small"><spring:message code="beach.message"/></i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'beach')"><spring:message code="search.message"></spring:message></a></p>
                                        </div>
                                    </div>
                                </li>
                                <li><div class = "promo" onmouseleave="$('#mountains').hide(700)" onmouseover="$('#mountains').show(700)"><img src="../search/resources/img/mountains.jpg" class="image_scroll" onload="$('#mountains').hide()"/>
                                        <div id="mountains" class="hilight">
                                            <i style="font-family: 'Book Antiqua';font-size: small"><spring:message code="ski.message"/></i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'mountains')"><spring:message code="search.message"></spring:message></a></p>
                                        </div>
                                    </div>
                                </li>
                                <li><div class = "promo" onmouseleave="$('#gambling').hide(700)" onmouseover="$('#gambling').show(700)"><img src="../search/resources/img/gambling.jpg" class="image_scroll" onload="$('#gambling').hide()"/>
                                        <div id="gambling" class="hilight">
                                            <i style="font-family: 'Book Antiqua';font-size: small"><spring:message code="gambling.message"/></i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'gambling')"><spring:message code="search.message"></spring:message></a></p>
                                        </div>
                                    </div>
                                </li>
                                <li><div class = "promo" onmouseleave="$('#historic').hide(700)" onmouseover="$('#historic').show(700)"><img src="../search/resources/img/historic.jpg" class="image_scroll" onload="$('#historic').hide()"/>
                                        <div id="historic" class="hilight">
                                            <i style="font-family: 'Book Antiqua';font-size: small">Earn Dollars</i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'historic')"><spring:message code="search.message"></spring:message></a></p>
                                        </div>
                                    </div>
                                </li>
                                <li><div class = "promo" onmouseleave="$('#national-parks').hide(700)" onmouseover="$('#national-parks').show(700)"><img src="../search/resources/img/national-parks.jpg" class="image_scroll" onload="$('#national-parks').hide()"/>
                                        <div id="national-parks" class="hilight">
                                            <i style="font-family: 'Book Antiqua';font-size: small">Earn Dollars</i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'national-parks')"><spring:message code="search.message"></spring:message></a></p>
                                        </div>
                                    </div>
                                </li>
                                <li><div class = "promo" onmouseleave="$('#outdoors').hide(700)" onmouseover="$('#outdoors').show(700)"><img src="../search/resources/img/outdoors.jpg" class="image_scroll" onload="$('#outdoors').hide()"/>
                                        <div id="outdoors" class="hilight">
                                            <i style="font-family: 'Book Antiqua';font-size: small">Earn Dollars</i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'outdoors')"><spring:message code="search.message"></spring:message></a></p>
                                        </div>
                                    </div>
                                </li>
                                <li><div class = "promo" onmouseleave="$('#romantic').hide(700)" onmouseover="$('#romantic').show(700)"><img src="../search/resources/img/romantic.jpg" class="image_scroll" onload="$('#romantic').hide()"/>
                                        <div id="romantic" class="hilight">
                                            <i style="font-family: 'Book Antiqua';font-size: small">Earn Dollars</i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'romantic')"><spring:message code="search.message"></spring:message></a></p>
                                        </div>
                                    </div>
                                </li>
                                <li><div class = "promo" onmouseleave="$('#shopping').hide(700)" onmouseover="$('#shopping').show(700)"><img src="../search/resources/img/shopping.jpg" class="image_scroll" onload="$('#shopping').hide()"/>
                                    <div id="shopping" class="hilight">
                                        <i style="font-family: 'Book Antiqua';font-size: small">Earn Dollars</i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'shopping')"><spring:message code="search.message"></spring:message></a></p>
                                    </div>
                                </div>
                                </li>
                                <li><div class = "promo" onmouseleave="$('#skiing').hide(700)" onmouseover="$('#skiing').show(700)"><img src="../search/resources/img/skiing.jpg" class="image_scroll" onload="$('#skiing').hide()"/>
                                    <div id="skiing" class="hilight">
                                        <i style="font-family: 'Book Antiqua';font-size: small">Earn Dollars</i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'skiing')"><spring:message code="search.message"></spring:message></a></p>
                                    </div>
                                </div>
                                </li>
                                <li><div class = "promo" onmouseleave="$('#theme-park').hide(700)" onmouseover="$('#theme-park').show(700)"><img src="../search/resources/img/theme-park.jpg" class="image_scroll" onload="$('#theme-park').hide()"/>
                                    <div id="theme-park" class="hilight">
                                        <i style="font-family: 'Book Antiqua';font-size: small">Earn Dollars</i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'theme-park')"><spring:message code="search.message"></spring:message></a></p>
                                    </div>
                                </div>
                                </li>
                                <li><div class = "promo" onmouseleave="$('#carribean').hide(700)" onmouseover="$('#carribean').show(700)"><img src="../search/resources/img/carribean.jpg" class="image_scroll" onload="$('#carribean').hide()"/>
                                    <div id="carribean" class="hilight">
                                        <i style="font-family: 'Book Antiqua';font-size: small">Earn Dollars</i><p><a class="btn" href="#" onclick="searchThemeRsp('DEN', 'carribean')"><spring:message code="search.message"></spring:message></a></p>
                                    </div>
                                </div>
                                </li>
                            </ul>
                ...
                <div class="row" style="padding-top: 5%;padding-bottom: 2%;">
                    <div class="col-md-12" id="slides">
                        <div><img src="../search/resources/img/airport_cab.jpg"/>
                            <div class="hilight">
                                <i style="font-family: 'Book Antiqua';font-size: medium"><spring:message code="taxi.title"></spring:message></i><p><a class="btn" href="http://www.abqtaxi.com"><spring:message code="visit.title"></spring:message></a></p>
                            </div>
                        </div>
                        <div><img src="../search/resources/img/lounge-liquor.jpg"/>
                            <div class="hilight">
                                <i style="font-family: 'Book Antiqua';font-size: medium"><spring:message code="liquors.title"></spring:message></i><p><a class="btn" href="#"><spring:message code="visit.title"></spring:message></a></p>
                            </div>
                        </div>
                        <div><img src="../search/resources/img/food_corner.jpg"/>
                            <div class="hilight">
                                <i style="font-family: 'Book Antiqua';font-size: medium"><spring:message code="eatery.title"></spring:message></i><p><a class="btn" href="#"><spring:message code="visit.title"></spring:message></a></p>
                            </div>
                        </div>
                        <div><img src="../search/resources/img/christmas.png"/>
                            <div class="hilight">
                                <i style="font-family: 'Book Antiqua';font-size: medium"><spring:message code="christmas.title"></spring:message></i><p><a class="btn" href="https://www.designbold.com/blog/20-last-minute-designs-etsy-shops-christmas/"><spring:message code="visit.title"></spring:message></a></p>
                            </div>
                        </div>
                        <div id="ad0"><img src="../search/resources/img/sports.jpg" class="advertisement"/>
                            <div id="advertisement0" class="hilight">
                                <i style="font-family: 'Book Antiqua';font-size: medium"><spring:message code="thrilling.ride"></spring:message> !!!</i><p><a id="hyper0" class="btn" href="#"><spring:message code="book.message"/></a></p>
                            </div>
                        </div>
                        <div id="ad1"><img src="../search/resources/img/pets.jpg" class="advertisement"/>
                        ...
                        <div id="ad2"><img src="../search/resources/img/romance.jpg" class="advertisement"/>
                            <div id="advertisement2" class="hilight">
                                <i style="font-family: 'Book Antiqua';font-size: medium"><spring:message code="anniversary.title"></spring:message></i><p><a id="hyper2" class="btn" href="#"><spring:message code="book.message"/></a></p>
                            </div>
                        </div>
                    </div>
                </div>
